...
Lemma sys_x_regular : red_regular sys_x.
Proof.
 intros_all. destruct H.
 split; trivial. apply body_to_subs; trivial.
 apply body'_to_body. unfold body'. simpl. omega.
 split; trivial. apply body_to_subs; trivial.
 apply term_is_a_body in H; trivial.
 split. apply body_to_subs; trivial. 
 apply body_distribute_over_application. split; trivial.
 apply term_distribute_over_application. 
 split; apply body_to_subs; trivial.
 split. apply body_to_subs; trivial.
 apply body_to_term_abs. apply body_to_body' in H.
 unfold body' in H. simpl in H. apply body'_to_body.
 unfold body'. simpl. apply term_is_a_body in H0.
 apply body_to_body' in H0. unfold body' in H0.
 split; trivial. apply lc_at_bswap; trivial. omega. 
 split. apply body_to_subs; trivial.
 apply body_to_subs. apply body'_to_body. 
 apply body_to_body' in H. unfold body' in *|-*.
 simpl in *|-*. apply term_is_a_body in H1.
 apply body_to_body' in H1. unfold body' in H1.
 split; trivial. apply lc_at_bswap. omega. apply H.
 apply body_to_subs; trivial.  apply body_to_body' in H.
 apply body'_to_body. unfold body' in *|-*. simpl in *|-*.
 apply H.
Qed.
...
Lemma ctx_sys_ex_regular : red_regular ex.
Proof.
 apply red_regular_eqC.
 apply sys_x_regular. 
Qed.

Lemma sys_Bx_regular : red_regular sys_Bx.
Proof.
 intros t u H; destruct H. destruct H.
 split. apply term_distribute_over_application; trivial.
 split; trivial. apply body_to_term_abs; trivial.
...
Lemma ctx_sys_Bex_regular : red_regular lex.
Proof.
 apply red_regular_eqC.
 apply sys_Bx_regular. 
Qed.
...
Proof. 
 ...
 simpl; apply reg_rule_var; apply term'_to_term;
 apply lc_at_subst; apply term_to_term'; trivial.
 simpl; apply reg_rule_gc; apply term'_to_term;
 apply lc_at_subst; apply term_to_term'; trivial.
 simpl; apply reg_rule_app; try apply body'_to_body;
 try apply term'_to_term; apply lc_at_subst; 
 try apply body_to_body'; try apply term_to_term'; trivial.
 apply body'_to_body. apply term_to_term' in H.
 apply lc_at_weaken_ind with (k1 := 0); trivial; omega.
 apply body'_to_body. apply term_to_term' in H.
 apply lc_at_weaken_ind with (k1 := 0); trivial; omega.
 simpl. unfold bswap. apply term_to_term' in H.
 rewrite subst_bswap_rec; trivial.
 simpl; apply reg_rule_lamb; try apply body'_to_body;
 try apply term'_to_term; apply lc_at_subst; 
 try apply body_to_body'; try apply term_to_term'; trivial.
 apply body_to_body' in H0. unfold body' in H0. 
 simpl in H0; trivial.
 apply lc_at_weaken_ind with (k1 := 0); trivial; omega.
 apply term'_to_term in H; trivial.
 simpl. unfold bswap. apply term_to_term' in H.
 rewrite subst_bswap_rec; trivial.
 simpl; apply reg_rule_comp.  apply body'_to_body.
 unfold body'. simpl. split. apply lc_at_subst.
 apply body_to_body' in H0. unfold body' in H0.
 ...
 simpl in H0. apply H0. 
 apply lc_at_weaken_ind with (k1 := 0); trivial; omega.
 intro H3. apply H1. apply term'_to_term. 
 apply term_to_term' in H3. 
 apply lc_at_subst' with (u := u) (x := x); trivial. 
 apply term'_to_term; apply lc_at_subst. 
 apply term_to_term'; trivial. trivial.
Qed.
...
Lemma ctx_sys_x_red_rename : red_rename (contextual_closure sys_x).
Proof.
 apply red_out_to_rename.
 apply ctx_sys_x_red_out.
Qed.

Lemma ctx_sys_Bx_red_rename : red_rename (contextual_closure sys_Bx).
Proof.
 apply red_out_to_rename.
...
Lemma ctx_sys_x_red_swap : red_swap (contextual_closure sys_x).
Proof.
 apply red_out_to_swap.
 apply ctx_sys_x_red_out.
Qed.

Lemma ctx_sys_Bx_red_swap : red_swap (contextual_closure sys_Bx).
Proof.
 apply red_out_to_swap.
 apply ctx_sys_Bx_red_out.
Qed.
